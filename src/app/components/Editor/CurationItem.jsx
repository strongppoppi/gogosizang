...
import nextButtonImage from "/public/icons/curved_arrow_white.png";
      ...
      {storeData && (
        <>
          <div className="flex flex-row justify-between items-center mb-4">
            ...
            <Link href={`/market/800`}>
              <div className="w-[44px] h-[44px] bg-main rounded-lg overflow-hidden flex flex-row justify-center items-center drop-shadow-sm">
                <Image
                  src={nextButtonImage}
                  width={24}
                  height={24}
