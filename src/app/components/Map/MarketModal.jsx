...
export default function MarketModal({ marketKey }) {
    ...
    return (
        <Link href={`/market/${marketKey}`}>
            <div className="w-11/12 absolute bottom-[174px] left-1/2 transform -translate-x-1/2 py-4 pl-4 pr-1 rounded-lg shadow-md flex flex-row justify-between items-center bg-white">
